# Key Vault
#ADE only gives ownership over RG, so we don't have permission to purge the KV from soft delete
#If you'd like to purge your KV, give your Project Environment Type Identity Owner permissions over the subscription,
# and then set purge_protection_enabled to false
module "key_vault" {
